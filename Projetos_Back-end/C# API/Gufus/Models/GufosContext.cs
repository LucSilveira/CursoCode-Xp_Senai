        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Categoria>(entity =>
            {
                entity.HasIndex(e => e.Titulo)
                    .HasName("UQ__Categori__7B406B56526D3051")
                    .IsUnique();
            ...
            modelBuilder.Entity<Evento>(entity =>
            {
                ...
                entity.HasOne(d => d.Localizacao)
                    ...
                    .HasConstraintName("FK__Evento__Localiza__4AB81AF0");
            });

            modelBuilder.Entity<Localizacao>(entity =>
            {
                entity.HasIndex(e => e.Cnpj)
                    .HasName("UQ__Localiza__AA57D6B43F30F2D2")
                    .IsUnique();

                entity.HasIndex(e => e.RazaoSocial)
                    .HasName("UQ__Localiza__7DD02876FB0377F1")
                    .IsUnique();
            ...
            modelBuilder.Entity<Presenca>(entity =>
            {
                ...
                entity.HasOne(d => d.Evento)
                    ...
                    .HasConstraintName("FK__Presenca__Evento__4D94879B");

                entity.HasOne(d => d.Usuario)
                    .WithMany(p => p.Presenca)
                    .HasForeignKey(d => d.UsuarioId)
                    .HasConstraintName("FK__Presenca__Usuari__4E88ABD4");
            });

            modelBuilder.Entity<TipoUsuario>(entity =>
            {
                entity.HasIndex(e => e.Titulo)
                    .HasName("UQ__Tipo_usu__7B406B56632594C3")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuario__A9D10534921A897E")
                    .IsUnique();
                ...
                entity.HasOne(d => d.TipoUsuario)
                    ...
                    .HasConstraintName("FK__Usuario__Tipo_us__3F466844");
            });
